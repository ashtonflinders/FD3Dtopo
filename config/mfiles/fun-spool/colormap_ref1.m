function cMap=colormap_ref1(varargin)
%
% colormap_ref1: Generate colormap.
%
% Usage: cMap=colormap_ref1(colorname)
%
...
%cMap(end+1,:) = colorname_ImageMagick('SlateBlue2');
cMap(end+1,:) = colorname_ImageMagick('MediumPurple');
%cMap(end+1,:) = colorname_ImageMagick('MediumPurple2');
%cMap(end+1,:) = colorname_ImageMagick('MediumPurple3');

cMap(end+1,:) = colorname_ImageMagick('SteelBlue1');

cMap(end+1,:) = colorname_ImageMagick('LightGreen');

cMap(end+1,:) = colorname_ImageMagick('LimeGreen');
cMap(end+1,:) = colorname_ImageMagick('green3');
