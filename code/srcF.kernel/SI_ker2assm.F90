...
write(fid,"(a,i10)") "max_band_width_Kap = ",max_bdap
write(fid,"(a,i10)") "max_band_width_Kaq = ",max_bdaq
write(fid,"(a,i10)") "max_band_width_Kbp = ",max_bdbp
write(fid,"(a,i10)") "max_band_width_Kbq = ",max_bdbq
close(fid)
