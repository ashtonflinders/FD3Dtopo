...
cmp=[];cmp0=[];cmp1=[];
cmp{end+1}= 'Ux'; cmp0{end+1}='U0'; cmp1{end+1}='( 1)';
cmp{end+1}= 'Uy'; cmp0{end+1}='U0'; cmp1{end+1}='( 1)';
cmp{end+1}= 'Uz'; cmp0{end+1}='U0'; cmp1{end+1}='( 1)';
ncmp=numel(cmp);
...
%ryid(end+1)= 0; stid(end+1)= 9;
%ryid(end+1)= 0; stid(end+1)=10;
%ryid(end+1)= 0; stid(end+1)=11;
%ryid(end+1)= 0; stid(end+1)=12;
%for n=1:99
